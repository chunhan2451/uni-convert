    ...
    <div class="converter-container max-w-3xl mx-auto">
        <div class="justify-center">
            <div class="p-2 bg-primary/10 rounded-lg flex mb-3 justify-self-center">
                <Icon :name="uiIcons.categoryIcons.dataspeed" class="text-primary h-6 w-6 text-2xl" />
            </div>
            <h1 class="text-3xl font-bold mb-8 text-center">Data Transfer & Internet Speed Converter</h1>
        </div>
