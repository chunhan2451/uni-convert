    ...
    <div class="container mx-auto p-4">
        <div class="max-w-xl mx-auto">
            ...
            <div class="mb-6">
                ...
                <select v-model="selectedCategory" class="select select-bordered w-full bg-white" @change="handleCategoryChange">
            ...
            <div class="mb-4">
                ...
                <div class="flex">
                    ...
                    <select
                        v-model="fromUnit"
                        class="select select-bordered rounded-l-none border-l-0 bg-white w-2/5"
            ...
            <div class="flex justify-center">
                <button @click="swapUnits" class="btn btn-circle btn-sm btn-outline" title="Swap units">
                    <Icon name="solar:transfer-vertical-linear" size="1.25rem" />
                </button>
            </div>
            ...
            <button v-show="toUnit && toValue" @click="copyToClipboard(toValue.toString())" class="btn btn-primary w-full mb-6">
                <Icon name="solar:copy-linear" size="1.25rem" />Copy Result
            </button>
