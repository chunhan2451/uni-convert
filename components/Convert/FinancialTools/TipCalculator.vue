...
<template>
      ...
      <div class="max-w-md mx-auto">
        ...
        <div>
          ...
          <div class="mt-5 text-center">
            <button @click="resetCalculator" class="btn btn-outline btn-sm">
              Reset
            </button>
          </div>
        </div>
  ...
  useHead({
    ...
    meta: [
      {
        name: 'description',
        content: 'Calculate restaurant tips easily and split bills among friends with our free online tip calculator. Simple, fast, and accurate.',
      }
    ],
  });
  </script>